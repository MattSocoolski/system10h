# PROCES WDROŻENIA BLIŹNIAKA BIZNESOWEGO

5 kroków od zakupu do codziennej pracy z AI.
...
> Jeśli klient wie kim jest i komu sprzedaje → pomijamy ten krok (Ścieżka Express).

---

## KROK 2: Wywiad z Architektem (tworzenie dna.md)
...
**Co robi klient (z moją asystą):**

1. Otwiera Claude → Projects → Nowy projekt "Bliźniak Biznesowy"
2. W sekcji Knowledge wkleja:
   - `dna.md` (wygenerowany przez Architekta)
   - `SKILL.md` z `system-10h-sales-twin/` (Bliźniak)
3. Testuje: wkleja prawdziwego maila → sprawdza czy Bliźniak odpowiada jego głosem

**Moja rola:** Wysyłam instrukcję krok po kroku + jestem dostępny na maila jeśli coś nie działa.

---

## KROK 4: Szkolenie (nagranie Loom)

**Format:** Nagranie Loom 15-20 min.
**Zawartość:**
1. Jak otworzyć Claude Projects i wkleić pliki (2 min)
...
## KROK 5: Codzienna praca

**Co klient robi każdego dnia:**
- Otwiera Claude Projects z Bliźniakiem
- Wkleja maila / pisze polecenie → Bliźniak odpowiada
- Workflow'y: odpisz, ofertuj, follow-up, outreach, research, content...

**Wsparcie:** 30 dni wsparcia mailowego po wdrożeniu.
...
| 5. Praca | Codziennie | Klient sam |

**Łączny czas wdrożenia:** 1-2 dni od momentu zakupu.
